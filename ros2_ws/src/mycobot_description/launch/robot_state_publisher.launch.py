...
def process_ros2_controllers_config(context):
    ...
    # Use proper ROS 2 package discovery instead of hardcoded paths
    ...
    if not os.path.exists(template_path):
        print(f"Warning: Template not found at {template_path}, skipping controller config processing")
        return []
